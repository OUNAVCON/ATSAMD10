...
#define SERCOM_CTRL(SERCOM)      (*((volatile uint8_t  *)(SERCOM+00)))
#define SERCOM_CHANNEL(SERCOM)   (*((volatile uint32_t *)(SERCOM+04)))
#define SERCOM_USER(SERCOM)      (*((volatile uint16_t *)(SERCOM+08)))
#define SERCOM_CHSTATUS(SERCOM)  (*((volatile uint32_t *)(SERCOM+0C)))
#define SERCOM_INTCLR(SERCOM)    (*((volatile uint32_t *)(SERCOM+10)))
#define SERCOM_INTENSET(SERCOM)  (*((volatile uint32_t *)(SERCOM+14)))
#define SERCOM_INTFLAG(SERCOM)   (*((volatile uint32_t *)(SERCOM+18)))
...
#define TCC_CTRLA          (*((volatile uint32_t *)(TCC+0x00)))
#define TCC_CTRLBCLR       (*((volatile uint8_t  *)(TCC+0x04)))
#define TCC_CTRLBSET       (*((volatile uint8_t  *)(TCC+0x05)))
#define TCC_SYNCBUSY       (*((volatile uint32_t *)(TCC+0x08)))
#define TCC_FCTRLA         (*((volatile uint32_t *)(TCC+0x0C)))
#define TCC_FCTRLB         (*((volatile uint32_t *)(TCC+0x10)))
#define TCC_WEXCTRL        (*((volatile uint32_t *)(TCC+0x14)))
#define TCC_DRVCTRL        (*((volatile uint32_t *)(TCC+0x18)))
#define TCC_DBGVTRL        (*((volatile uint8_t  *)(TCC+0x1E)))
#define TCC_EVCTRL         (*((volatile uint32_t *)(TCC+0x20)))
#define TCC_INTENCLR       (*((volatile uint32_t *)(TCC+0x24)))
#define TCC_INTENSET       (*((volatile uint32_t *)(TCC+0x28)))
#define TCC_INTFLAG        (*((volatile uint32_t *)(TCC+0x2C)))
#define TCC_STATUS         (*((volatile uint32_t *)(TCC+0x30)))
#define TCC_COUNT          (*((volatile uint32_t *)(TCC+0x34)))
#define TCC_PATT           (*((volatile uint16_t *)(TCC+0x38)))
#define TCC_WAVE           (*((volatile uint32_t *)(TCC+0x3C)))
#define TCC_PER            (*((volatile uint32_t *)(TCC+0x40)))
#define TCC_CC(x)          (*((volatile uint32_t *)(TCC+0x44 + (x*0x4))))
#define TCC_PATTB          (*((volatile uint16_t *)(TCC+0x64)))
#define TCC_WAVEB          (*((volatile uint32_t *)(TCC+0x68))))
#define TCC_PERB           (*((volatile uint32_t *)(TCC+0x6C)))
#define TCC_CCB(x)         (*((volatile uint32_t *)(TCC+0x70 + (x*0x4))))
